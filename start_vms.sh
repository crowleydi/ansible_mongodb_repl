...
docker run --detach --rm --hostname mongo0 --name mongo0 --network mynet --ip 172.18.0.3 mysshimage
# start "slaves"
#docker run --detach --rm --hostname mongo1 --name mongo1 --network mynet --ip 172.18.0.4 rastasheep/ubuntu-sshd
docker run --detach --rm --hostname mongo1 --name mongo1 --network mynet --ip 172.18.0.4 mysshimage
#docker run --detach --rm --hostname mongo2 --name mongo2 --network mynet --ip 172.18.0.5 rastasheep/ubuntu-sshd
docker run --detach --rm --hostname mongo2 --name mongo2 --network mynet --ip 172.18.0.5 mysshimage
